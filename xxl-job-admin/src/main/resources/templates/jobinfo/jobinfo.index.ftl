                        ...
                        <div class="box-body" >
                            <table id="job_list" class="table table-bordered table-striped" width="100%" >
                                ...
                                <tr>
                                    ...
                                    <th name="alarmWorkWx" >${I18n.jobinfo_field_alarm_work_wx}</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="alarmWorkWx" class="col-sm-2 control-label">${I18n.jobinfo_field_alarm_work_wx}<font color="black">*</font></label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="alarmWorkWx" placeholder="${I18n.jobinfo_field_alarm_work_wx_placeholder}" maxlength="100" ></div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal form" role="form" >
                    ...
                    <div class="form-group">
                        <label for="lastname" class="col-sm-2 control-label">${I18n.jobinfo_field_alarm_work_wx}<font color="black">*</font></label>
                        <div class="col-sm-10">
                            <textarea type="text" class="form-control" name="alarmWorkWx" placeholder="${I18n.jobinfo_field_alarm_work_wx_placeholder}" maxlength="512" style="height: 63px; line-height: 1.2;"></textarea>
                        </div>
                    </div>
